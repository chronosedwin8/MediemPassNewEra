...
export interface Guion {
  ...
  resumen: string;
  /**
   * El texto hablado, dividido en escenas.
   *
   * Se divide porque HeyGen renderiza una escena por entrada y un plano fijo
   * de dos minutos se hace largo de ver. Cada escena es una idea.
   */
  escenas: string[];
}
...
export const GUIONES: Guion[] = [
  ...
  },
  {
    ...
    escenas: [
      'Detrás de cada contenido hay una intención. Detrás de cada recomendación, también.',
